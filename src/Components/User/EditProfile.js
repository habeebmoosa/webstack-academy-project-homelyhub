                ...
                <div className="col-10 col-lg-5 updateprofile">
                    <form onSubmit={handleUpdate} encType="multipart/form-data">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" id="phonenumber_field" className="form-control" 
                        ...
                        <div className="form-group">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <div className="custom-file">
                                    <input type="file" name="avatar" className="custom-file-input" id="avatar_update" accept="image/*"
                                        onChange={handleAvatarChange} />
                                    <label className="custom-file-label" htmlFor="avatar_update"> Choose Avatar </label>
                                    <p className="notes">(Image size should be less than 20 kb)</p>
                                </div>
                            </div>
                        </div>
